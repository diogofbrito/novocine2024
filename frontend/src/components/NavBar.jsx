...
export function NavBar() {
  ...
  return (
    <ThemeProvider>
      <>
        <div className={`fixed z-50 top-0 px-[4.5rem] iphone:px-[1rem] flex w-screen h-[4.5rem] items-center opacity-0 mobileNavBar ${(animationDone || isNotHomePage) && '!opacity-100'}`} ref={navbarRef}>
          {!isFilmDetailPage ? (
