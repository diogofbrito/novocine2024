...
export function NavBar() {
	...
	return (
		<>
			...
			{showNewsletter && (
				<div className='newsletter fixed top-0 bottom-0 left-0 right-0 z-50 flex justify-center items-center bg-opacity-50 backdrop-blur-xl flex-col gap-4'>
					<div>Subscreve a nossa newsletter para acompanhares todas as novidades.</div>
					<div className='flex flex-row gap-4 '>
						<input
							type='text'
							placeholder='Primeiro Nome'
							className='px-3 py-1 border rounded-full outline-none hover:bg-[rgba(255,255,255,0.5)] dark:hover:bg-[rgba(234,235,222,0.5)] transition duration-300 ease-in-out bg-transparent input-placeholder'
							value={firstName}
						...
						/>
						<div className='flex gap-4 pl-3 pr-2 py-1 border rounded-full hover:bg-[rgba(255,255,255,0.5)] dark:hover:bg-[rgba(234,235,222,0.5)] transition duration-300 ease-in-out'>
							<input
								type='email'
								placeholder='Email*'
