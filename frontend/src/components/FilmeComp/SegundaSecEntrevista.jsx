	...
	return (
		<div className='my-14 iphone:my-6'>
			<div className='flex justify-center '>
				<div className='w-3/6 font-regular text-xl leading-[1.4] iphone:w-full iphone:text-base '>
					{autorEntrevista && <div className='pb-4 font-oblique'>{autorEntrevista}</div>}
					<PortableText
						value={entrevista}
						components={{
