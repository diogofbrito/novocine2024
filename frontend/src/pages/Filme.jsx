	...
	return (
		<>
			...
			<div className='m-[4.5rem] iphone:mx-[1rem] iphone:mb-[2rem] '>
				<div className=' h-[calc(100vh-9rem)] flex flex-col w-full gap-6 iphone:h-full '>
					...
					<div className='flex-grow iphone:hidden'>{stillsUrls.length > 0 && <Carousel images={stillsUrls} />}</div>
					<div className='hidden iphone:block'>{stillsUrls.length > 0 && <CarouselMobile images={stillsUrls} />}</div>
				</div>
