    ...
    return (
        <>
            <Helmet>
                ...
                <meta
                    name="description"
                    content={translation[lang].sobreNovocine}
                />
                <meta name="robots" content="index, follow" />
                <meta
                    name="keywords"
                    content={translation[lang].keywordsArquivo}
                />
            </Helmet>
                        ...
                        {isLoading ? (
                            ...
                            >
                                {isListView ? (
                                    <ArchiveList
                                        films={allFilms}
                                        onFilmClick={cancelSmoothScrolling}
                                    />
                                ) : (
                                    <Masonry
                                        ...
                                        {allFilms.length > 0 ? (
                                            allFilms.map((film) => (
                                                <Link
                                                    ...
                                                    to={`/${routeTranslations.arquivo[lang]}/${film.slug?.current}`}
